...
descriptions = {
    ...
    '好医保': 'Expenses:09-保险:02-商业保险:01-医疗',
    '中国石(油|化)|加油': 'Expenses:05-交通:02-加油',
    '充电订单免密支付|劲桩|特来电|快电|国家电网|壳牌充电|南网电动充电|延长壳牌广东': 'Expenses:05-交通:03-充电',
    ...
    '阿里云|(话费|流量).*充值|(中国|江西)(电信|联通)': 'Expenses:11-通信:01-电信',
    '辣椒|葱|鸡蛋|红薯|土豆|胡萝卜|菠菜|生菜': 'Expenses:01-饮食:01-食品',
    '智能货柜消费': 'Expenses:01-饮食:02-饮品',
    '美食|餐厅|烤肉店|朴朴|华(南理)?工.*饭堂|炒栗子|意面|烧饼': 'Expenses:01-饮食:03-餐饮服务',
    '迪卡侬|服饰|(休闲|运动)裤|马登(工装)?': 'Expenses:02-服饰',
    '物业管理': 'Expenses:03-居住:02-物业',
    '水费|天天一泉售水机': 'Expenses:03-居住:03-水电',
    '酒店': 'Expenses:03-居住:04-酒店',
    '美发|牙刷': 'Expenses:04-生活',
    '学贷还款|考试费': 'Expenses:06-文化娱乐:01-教育',
    '书籍|鲜花|景区门票': 'Expenses:06-文化娱乐:03-用品',
    '剪映.*(订阅|服务)|省钱卡|微信立减金券包|团费': 'Expenses:06-文化娱乐:04-服务',
